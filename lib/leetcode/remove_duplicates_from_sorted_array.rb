...
# Hint 1
# In this problem, 
# the key point to focus on is the input array being sorted. 
...
# array would potentially be smaller than the size of the input array. 
# So, we ought to use a two-pointer approach here. 
# One, that would keep track of the current element in the original
